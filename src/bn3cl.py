...
def main():
        ...
        parser.add_argument("-fl", "--folderlock", help="Folder Lock Mode, integer.", type=int, choices=[0,1,2,3,4,5], default=0)
        ...
        if args.input >= 1:
                ...
                FOLDER_MODE = int(input("Enable Folder Lock Mode? [0-5]> ")) % 6
